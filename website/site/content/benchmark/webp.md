...
| Docker Image  | [docker.io/bensuperpc/multimedia:1.0.0-archlinux-base-20250329](https://github.com/bensuperpc/docker-multimedia) |

## Lossless compression

The dataset for the **lossless** benchmark is:

- ~9900 screenshots (32'253 Mo) from Minecraft (720p to 1440p, some 2160p).
- ~9600 screenshots (41'738 Mo) from Fortnite, Battlefield, 7 Days to Die, and GTA V etc... (1080p to 1440p, some 2160p).
- ~2150 screenshots (901 Mo) from desktop applications (240p to 1440p).
